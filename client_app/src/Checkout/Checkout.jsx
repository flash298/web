                                    ...
                                    <div className="row">
                                        <div className="col-md-12">
                                            <div className="checkout-form-list">
                                                ...
                                                <input onChange={(e)=> set_from(e.target.value)} type="text" name="from"
                                                    id="from_places"
                                                    value={from} />
                                                <input onChange={(e)=> set_from(e.target.value)} id="origin" name="origin" required="" type="hidden"
                                                    value={from} />
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                            <div className="checkout-form-list">
                                                ...
                                                <input onChange={onChangeAddress} id="destination" type="text" name="destination" required="" type="hidden" />
                                            </div>
                                        </div>
                                        <div className="col-md-12">
                                            <div className="checkout-form-list">
