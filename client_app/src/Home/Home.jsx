    ...
    <div className="container">
      <div className="slider-with-banner">
        <div className="row align-items-stretch" style={{ display: "flex", alignItems: "stretch" }}>
          <div className="col-lg-8 col-md-8" style={{ height: "533.1px" }}>
            <div className="carousel-inner" style={{ height: "100%" }}>
              <div
                ...
                style={{
                  backgroundImage: "url(https://themewagon.github.io/violet/img/slider-1.jpg)",
                  height: "100%",
                }}
              >
          ...
          <div
            className="col-lg-4 col-md-4 text-center pt-xs-30"
            style={{ display: "flex", flexDirection: "column", height: "100%" }}
          >
            <div className="li-banner" style={{ flexGrow: 1 }}>
              <a href="#">
                <img
                  src="https://themewagon.github.io/violet/img/f-box-1.jpg"
                  alt=""
      ...
      <Home_Product gender={`Nam`} category={"male"} GET_id_modal={GET_id_modal} />

      <Home_Product gender={`Nữ`} category={"female"} GET_id_modal={GET_id_modal} />
                  ...
                  <div className="product-details-view-content pt-60">
                    <div className="product-info">
                      ...
                      <div className="price-box pt-20">
                        ...
                        {priceSale && (
                          <span className="new-price new-price-2">
                            {new Intl.NumberFormat("vi-VN", { style: "decimal", decimal: "VND" }).format(priceSale) +
                              " VNĐ"}
                          </span>
                        )}
                      </div>
                      <div className="product-desc">
                        <p>
                          <span>
                            {product_detail.describe} Veritatis reiciendis hic voluptatibus aperiam culpa ullam dolor
                            esse error ducimus itaque ipsa facilis saepe rem veniam exercitationem quos magnam, odit
                            perspiciatis.
                          </span>
                        </p>
                      </div>
